...
#
# 10/13/2020 - Updates by luke@socially-inept.net made to make module
#               compatible with Python3, corrected a few very minor
#               PIP things.
#
...
def example_triple_des():
    ...
    t = time()
    t1 = TripleDES(unhex("133457799BBCDFF1112233445566778877661100DD223311"))
